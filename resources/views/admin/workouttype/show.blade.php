                             ...
                             <table class="table table-bordered table-striped table-hover dataTable" id="all-user-datatable">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                          <td>{{++$key}}</td>
                                          <td>{{$type->name}}</td>
                                          <td>{{$type->sequence_no}}</td>
                                            <form class="form-horizontal" method="post" action="{{url('admin/delete-workout-type').'/'.$type->id}}" role="form">
                                    @csrf
                                 <td>
                                        <a href="{{url('admin/edit-workout-type').'/'.$type->id}}"><button type="button" class="btn btn-primary waves-effect">Edit</button></a>
