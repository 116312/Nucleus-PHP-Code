                                ...
                                <tbody>
                                        ...
                                        <tr>
                                          ...
                                          <td>{{$language->name}}</td>
                                            ...
                                            <form class="form-horizontal" method="post" action="{{url('admin/delete-language').'/'.$language->id}}" role="form">
                                    @csrf
                                 <td>
                                        <a href="{{url('admin/edit-language').'/'.$language->id}}"><button type="button" class="btn btn-primary waves-effect">Edit</button></a>
