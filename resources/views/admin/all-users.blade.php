...
<!--<button data-toggle="modal" data-target="#detail" data-backdrop="static" data-keyboard="false" type="button" class="btn btn-success waves-effect">View Detail</button>-->
