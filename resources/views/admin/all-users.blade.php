...
@section('admin-section')
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card over-flow_table">
                        <div class="header">
                              <!-- Nav tabs -->
                      <ul class="nav nav-tabs newtab tabs_responsive " role="tablist">
                        <li role="presentation" class="active"><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Free Users ({{ $totalFreeUsers }})</a></li>
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Subscribed Users ({{ $totalSubscribedUsers }})</a></li>
                      </ul>
                        </div>
                        <div class="body">
                      <!-- Tab panes -->
                      <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="home">
                             <table class="table table-bordered table-striped table-hover js-basic-example dataTable" id="all-user-datatable1">
                                <thead>
                                <tr>
                                    <td>S No.</td>
                                    <td>User Name</td>
                                   ...
                                   <tr>
                                    ...
                                    @csrf
                                       <td>
                                         ...
                                         <a href="" onclick="return confirm('Are you sure you want to delete this item?');"><button type="submit" class="btn btn-danger waves-effect">Delete</button></a> </form>
                                         <a href="{{url('admin/assign-subscription').'/'.$user->id}}" onclick="return confirm('Are you sure you want to Assign Subscription of this user?');"><button  type="submit" class="btn btn-sucess waves-effect">Assign Subscription</button></a></td>
                        ...
                        <div role="tabpanel" class="tab-pane" id="profile">
                              <table class="table table-bordered table-striped" id="all-user-datatable2">
                                <thead>
                               <tr>
                                    <td>S No.</td>
                                    <td>User Name</td>
                                ...
                                <tbody>
                             @foreach($subscribedUsers as $key => $user)
                             @php
                             ...
                             @endphp
                                <tr>
                                       ...
                                       <td>{{$user->product}}</td>
                                        ...
                                        <td>{{$user->amount}}</td>
                                       @if($user->Device_Type=="IOS" || $user->receipt!="")
 ...
 <div id="detail" class="modal fade" role="dialog">
  ...
  <tbody>
    ...
    <script>
    $(function(){
    $("#all-user-datatable1").dataTable()fnDestroy();
  })
  </script>
   <script>
    $(function(){
    $("#all-user-datatable2").dataTable();
  })
  </script>
