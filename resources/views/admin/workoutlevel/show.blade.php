                        ...
                        <div class="body">
                             ...
                             <table class="table table-bordered table-striped table-hover dataTable" id="all-user-datatable">
                                ...
                                <tbody>
                                        ...
                                        @foreach($workoutlevels as $key => $level)
                                        <tr>
                                            <td>{{++$key}}</td>
                                            ...
                                            <form class="form-horizontal" method="post" action="{{url('admin/delete-workout-level').'/'.$level->id}}" role="form">
                                    @csrf
                                                <td>
                                                     <a href="{{url('admin/edit-workout-level').'/'.$level->id}}"><button type="button" class="btn btn-primary waves-effect">Edit</button></a>
