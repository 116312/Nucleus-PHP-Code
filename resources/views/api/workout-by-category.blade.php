...
<h1>
    ...
    URL::{{url('/').'/api/get-workout-by-category'}}

</h1>
<form method="POST" enctype="multipart/form-data" action="{{url('/api/get-workout-by-category')}}" >
   ...
   Users(user_id)::*<select name="user_id" required>
    ...
    Category(cate_id)::*<select name="cate_id" required>
    <option value="">Select</option>
